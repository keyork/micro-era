      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full rounded-[24px] px-4 py-4 text-base resize-none outline-none transition-all"
            style={{
              background: 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.08)',
              color: 'var(--text-primary)',
            }}
            onFocus={(e) => (e.target.style.borderColor = 'rgba(119, 125, 247, 0.8)')}
          ...
          <div className="mt-3 flex items-center justify-between gap-3">
            ...
            <span
              ...
              style={{
                background: canSubmit ? 'rgba(83,198,175,0.14)' : 'rgba(255,255,255,0.06)',
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {contentTypes.map((ct) => (
              <button
                ...
                style={{
                  background: contentType === ct.value ? 'rgba(119, 125, 247, 0.18)' : 'rgba(255,255,255,0.03)',
                  color: contentType === ct.value ? 'var(--text-primary)' : 'var(--text-secondary)',
                  border: `1px solid ${contentType === ct.value ? 'rgba(119, 125, 247, 0.45)' : 'rgba(255,255,255,0.06)'}`,
                  boxShadow: contentType === ct.value ? '0 0 0 1px rgba(119,125,247,0.18) inset' : 'none',
                }}
              >
                {ct.label}
              </button>
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-[24px] px-4 py-3 text-base outline-none transition-all"
            style={{
              background: 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.08)',
              color: 'var(--text-primary)',
        ...
        {error && (
          <p className="rounded-2xl px-4 py-3 text-sm" style={{ color: 'var(--color-pink)', background: 'rgba(240,108,140,0.08)', border: '1px solid rgba(240,108,140,0.18)' }}>
            {error}
          </p>
        )}
        ...
        {isLoading && (
          <div
            ...
            style={{
              background: 'linear-gradient(180deg, rgba(119,125,247,0.12), rgba(255,255,255,0.03))',
              border: '1px solid rgba(119,125,247,0.2)',
            }}
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <div
                ...
                style={{
                  border: '2px solid rgba(119,125,247,0.16)',
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: isDone ? 'var(--color-teal)' : isActive ? 'var(--color-primary)' : 'rgba(255,255,255,0.08)',
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full rounded-[24px] py-4 text-base font-semibold transition-all disabled:opacity-40"
          style={{
            background: 'linear-gradient(135deg, #6f77ff, #53c6af)',
            color: '#fff',
            boxShadow: '0 18px 60px rgba(83,198,175,0.2)',
          }}
        >
